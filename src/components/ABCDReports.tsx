    ...
    <section id="reports" className="py-20 md:py-[120px]">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <ScrollReveal delay={0.2}>
          <p className="text-secondary font-body text-base leading-relaxed max-w-[640px] mb-8">
        ...
        <ScrollReveal delay={0.3}>
          <a
            href="/reports/ABCD_Report.pdf"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-8 py-3.5 bg-red text-white rounded-full font-body font-semibold text-sm hover:shadow-lg hover:shadow-red/30 transition-all mb-10"
          >
            ↓ Download Sprint Reports
          </a>
        </ScrollReveal>
